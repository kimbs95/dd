...
public class ReplyVO {
	...
	@JsonFormat(pattern = "yyyy-MM-dd HH시mm분")
	...
	public ReplyVO(String reply_content, int reply_Num, int rp_parent_No, Date reply_regDate, String user_Id,
			int inte_Num) {
		super();
	...
	public String toString() {
		return "ReplyVO [reply_Num=" + reply_Num + ", reply_content=" + reply_content + ", user_Id=" + user_Id
				+ ", reply_regDate=" + reply_regDate + "," + "inte_Num= " + inte_Num + ", rp_parent_No=" + rp_parent_No
				+ "]";
	}
