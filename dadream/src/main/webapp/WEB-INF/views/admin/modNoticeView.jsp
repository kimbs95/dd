                ...
                <main>
                    ...
                    <form method="post" action="/admin/modNotice.do">
                        <div class="">
                            ...
                            게시판 번호 : <input type="text" value="${noticeView.notice_Num}" name="notice_Num"  disabled/>
                        ...
                        <div style="display: flex;">
                            내용: <textarea name="notice_Text" style="width: 900px; height:500px">${noticeView.notice_Text}</textarea>
                        </div>
                        <div class="">
