...
<div class="mypage">
    <div>
        ...
        <input type="text" value="사용자아이디" disabled="disabled"><br>
        ...
        <input type="password" name="userPwdConfirm" id="pwd2" placeholder="다시 입력하세요" required="required"
            style="margin-top:3px ;">
        <div class="alert alert-success" id="alert-success">비밀번호가 일치합니다.</div>
        <div class="alert alert-danger" id="alert-danger">비밀번호가 일치하지 않습니다.</div>
        <br>
        <input type="submit" name="mod" value="변경" style="font-weight:700; margin-top:3px;"><br><br>
        <form>
            <label style="font-weight:700;">주소</label><br>
            <input type="text" size="30" disabled="disabled">&nbsp;<button type="submit"
                style="font-weight: 700;">주소찾기</button><br><br>
            <label style="font-weight: 700;">상세주소</label><br>
            <input type="text" size="20" placeholder="상세주소를 입력해주세요." style="margin-top: 3px;">
            <input type="submit" name="mod" value="변경" style="font-weight:700; margin-top:3px;"></form>
    </div>
    <br>
    <h2 style="font-weight: 900; font-size: 2em;">내가 등록한 방</h2>
    <div id="myroom">
        <div style="display: flex;">
            <div style="width: 200px; height: 200px;"><img src="images/네이버.PNG" style="width:200px; height: 200px;">
            </div>
