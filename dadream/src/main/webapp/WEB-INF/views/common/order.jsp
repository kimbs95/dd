...
<body>
    ...
    <script>
        var tossPayments = TossPayments("test_ck_jkYG57Eba3G7LGlBJkj3pWDOxmA1");
        ...
        button.addEventListener("click", function () {
            ...
            if (method === '가상계좌') {
                paymentData.virtualAccountCallbackUrl = window.location.origin + '/virtual-account/callback.do'
            }
