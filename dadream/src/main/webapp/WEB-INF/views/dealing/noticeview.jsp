	...
	<form  id="readForm" method="post" action="${contextPath}/notice/update" enctype="multipart/form-data">
		<input type="hidden" name="notice_Num" value="${noticeContents.notice_Num }" />
			...
			<div >
				...
				<td colspan="2">
					<input type="text" size="63" maxlength="100" value="${noticeContents.notice_Title }" name="notice_Title" disabled /></td>
			</div>

			<div >
					<div>
						<td align="rigth" valign="top">내용&nbsp;&nbsp; </td>
					<td><textarea rows="20" cols="65" value="${noticeContents.notice_Text}" name="notice_Text" disabled>${boardContents.notice_Text } </textarea>
					</td>
					</div>
			</div>
			...
			<div id="readbtn">	
				...
				<button id="updatebtn"><a href="/notice/update?notice_Num=${boardContents.notice_Num}" class="mod_btn">수정</a></button>
			
				<!-- <button type="submit" class="delete_btn">삭제</button> -->
				<!-- <a href="javascript:void(0);" class="btn btn-danger" onclick="deleteConfirm();">삭제</a> -->
				<input id="delete"type="button" value="삭제하기" onClick="fn_remove_article('${contextPath}/notice/removeArticle.do','${noticeContents.notice_Num}')">
