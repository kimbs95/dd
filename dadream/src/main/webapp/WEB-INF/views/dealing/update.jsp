    ...
    <form name="frmArticle" action="/board/update_action" method="post" enctype="multipart/form-data" onsubmit="return _onSubmit();">
		...
		<table border="0" align="center" class="table-responsive">
			<tr>
				...
				<td class="form-inline" colspan="2" align="left"><input type="text" size="20" maxlength="100" name="user_Id" value="${boardContents.user_Id}" readonly /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="form-inline" colspan="2"><textarea rows="10" cols="65" maxlength="4000" name="inte_Text"
					value="${boardContents.inte_Text}">${boardContents.inte_Text}</textarea>
				</td>
			</tr>
			<tr>
